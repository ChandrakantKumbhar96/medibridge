...
export default function DoctorSettings() {
  ...
  return (
    <DashboardLayout badge="Doctor" navItems={doctorNav}>
      ...
      <form onSubmit={save}>
        <Card className="mt-6">
          <h2 className="text-lg font-bold text-sand-900">Professional Information</h2>
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            <Field label="License Number">
              ...
              <Input value={form.license_number} disabled className="bg-sand-50 text-sand-500" />
            </Field>
        ...
        <Card className="mt-6">
          <h2 className="text-lg font-bold text-sand-900">Consultation Settings</h2>
